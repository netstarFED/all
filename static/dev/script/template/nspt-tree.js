NetstarTemplate.tree = (function(){
    ...
    var eventManage = {
        ...
        addNode : function(treeId, treeNode){
            ...
            commonManage.addNodeByAjax(newNodeData, _config, function(resData, _config, _newNodeData){
                ...
                /***20191226 添加返回的所有参数点击需要***/
                for(var key in resData){
                    newNode[key] = resData[key];
                }
                /***20191226***/
        ...
        //用于捕获节点生成 DOM 后的事件回调函数 sjj 20191111
        onNodeCreated:function(event, treeId, treeNode){
            if(typeof(treeNode.nsStateLabel)=='number'){
                var stateClassStr = '';
                switch(Number(treeNode.nsStateLabel)){
                    case 0:
                        //正常
                        stateClassStr = ' infonode';
                        break;
                    case 1:
                        //警告
                        stateClassStr = ' warningnode';
                        break;
                    case 2:
                        //错误
                        stateClassStr = ' errornode';
                        break;
                    case 3:
                        //成功
                        stateClassStr = ' successnode';
                        break;
                    case 4:
                        //禁用
                        stateClassStr = ' disablenode';
                        break;
                }
                $('#'+treeNode.tId+'_a').addClass(stateClassStr);
            }
        },
    ...
    var treeManage = {
        ...
        getZTreeSetting : function(config){
            ...
            //sjj 20191111给节点绑定class
            setting.callback.onNodeCreated = eventManage.onNodeCreated;
