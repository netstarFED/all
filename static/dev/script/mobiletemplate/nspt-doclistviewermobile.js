...
NetstarTemplate.templates.docListViewerMobile = (function(){
	function dialogBeforeHandler(data){
		...
		data.options = {idField:config.mainConfig.idField};
		data.config = config;
		return data;
	}
				...
				gridConfig.data.dataSource = [
					{
						...
						"id": 1,
						"itemCode": "000002",
						"itemName": "灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分灰分",
						"stdName": "灰分",
						"englishName": null,
						"wb": null,
						"py": "HF",
