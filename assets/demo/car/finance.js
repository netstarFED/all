var finance = {};//财务管理
finance.sendinvoice = {};
finance.sendinvoice.input = {};//业务开票界面
finance.sendinvoice.pop = {};//打开业务单据

finance.receivedinvoice = {};
finance.receivedinvoice.input = {};//业务收票界面
finance.receivedinvoice.pop = {};//打开订单界面
//发票类型
var invoiceArr = [
	{
		invoiceId:'0',
