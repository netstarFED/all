...
//nsValid.quote  
$.validator.addMethod("quote", function(value, element) { 
	return this.optional(element) || (nsValid.quote(value));
}, nsValid.msg.quote);
